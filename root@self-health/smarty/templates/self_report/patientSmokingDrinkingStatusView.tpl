                ...
                <div class="medium-12 end columns">
                    <ul class="medium-block-grid-2 small-block-grid-1">
                        <li>
                            ...
                            {if $patientSmokingDrinkingStatus->isSmoker()}
                                <div class="row">
                                    <div class="medium-6 end columns small-text-left medium-text-right">
                                        <label>
                                ...
                                {if $patientSmokingDrinkingStatus->hasStoppedSmoking()}
                                    <div class="row">
                                        <div class="medium-6 end columns small-text-left medium-text-right">
                                            <label>
                        ...
                        <li>
                            ...
                            {if $patientSmokingDrinkingStatus->isDrinker()}
                                <div class="row">
                                    <div class="medium-6 end columns small-text-left medium-text-right">
                                        <label>
                                ...
                                {if $patientSmokingDrinkingStatus->hasStoppedDrinking()}
                                    <div class="row">
                                        <div class="medium-6 end columns small-text-left medium-text-right">
                                            <label>
