	...
	*/
	public function mapFormToEntity($request){
        ...
        public function additionalUniqueCheck(array $arr, $id){
            ...
            $passed = true;
            if(count($arr > 2)){ // make sure the structure is valid
                ...
                for ($i = 1; $i < count($arr); $i++) {
                    ...
                    $val = ($propertyValue[1] != "") ? $this->prepSqlValues($propertyValue[1], $dbFieldType[1]) : $this->prepSqlValues($this->$methodName(),$dbFieldType[1]);
