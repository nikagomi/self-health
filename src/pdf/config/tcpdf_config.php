 ...
 */
define ('K_PATH_MAIN', '/var/www/smart/src/pdf/');
 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_FONTS', '/var/www/smart/src/pdf/fonts/');

/**
 * Default images directory.
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', '/var/www/html/facility_emblems/');
 ...
 */
define ('PDF_HEADER_LOGO_WIDTH', 34);
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'SM@RT');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'SM@RT');
 ...
 */
define ('PDF_HEADER_STRING', "Randal Neptune");
