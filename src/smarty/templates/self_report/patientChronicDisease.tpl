                    ...
                    <div class="medium-9 end columns">
                        <ul class="medium-block-grid-3 small-block-grid-2">
                            {foreach from=$chronicDiseases item=cd}
                                <li>
                                    <div>
                                        <label for="{$cd->getId()}" style="font-size:1.1rem;font-family:'Poppins', sans-serif;font-weight:600;color:#464646;margin-bottom:0px !important;padding-bottom:1px !important;"> 
