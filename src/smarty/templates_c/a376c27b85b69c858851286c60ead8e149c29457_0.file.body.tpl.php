<?php
/* Smarty version 3.1.34-dev-7, created on 2021-04-15 13:49:05
  from '/var/www/oecs/src/smarty/templates/base/body.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_60784451243fc6_98018653',
...
function content_60784451243fc6_98018653 (Smarty_Internal_Template $_smarty_tpl) {
...
<style type="text/css">
    ...
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_172840432760784451215632_12957714', 'styles');
?>
...
<?php echo '<script'; ?>
 type="text/javascript">
    ...
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_45199076760784451216114_61155003', 'scripts');
?>
...
"
            ...
            var dTable = $("#listTable, .listTable").DataTable({
                    ...
                    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_3009848736078445121db84_26172907', 'dataTable');
?>
            ...
            *************************************************/
            ...
            $('body').on("click","#toggleSidebar", function () {
                ...
                if (!smallScreen.matches) {// not a small screen so sidebar may stay visible
                    if (sessionStorage.getItem("sidebarSwitch") == "on" && !$("#sidebar").hasClass("active")) {
                        sessionStorage.setItem("sidebarSwitch", "off");
                    } else {
                        if (sessionStorage.getItem("sidebarSwitch") == "off" && $("#sidebar").hasClass("active")) {
                            sessionStorage.setItem("sidebarSwitch", "on");
                        } 
                    }
                }
            ...
            *******************************************/
            ...
            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_4981187316078445121e408_05891196', 'jquery');
?>
...
<title>
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_18400291936078445121ebd7_65316955', 'title');
?>
    ...
    <div id="wrapper">
            ...
            <nav id="sidebar" >
                ...
                <div class="logoContainer" >
                    <img src="/images/OECS_Logo_400px.png" height="400px" width="200px" style="margin-bottom:5px;"/>
                    <br/>
                                        <img src="/images/flag_banner.png"/>
                    <br/>
                    <span class="tagLine">One Community. Growing Together.</span>
                    <br/><br/>                                                                                                                                              
                </div>
...
">Your Patient Profile</a>
                                    </li>
                                    <li>
                                        <a href="/next/of/kin/form">Next of Kin</a>
                                    </li>
                                <?php }?>
                            </ul>
                        </li>
                    ...
                    <?php if ($_SESSION['isPatient']) {?>
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="healthSubmenu">
                                ...
                                <li>
                                    <a href="/patient/covid19/vaccination/form">Covid-19 Vaccination</a>
                                </li>
                                <li>
                                    <a href="/patient/chronic/disease/form">Chronic Diseases</a>
                                </li>
                                <li>
                    ...
                    <?php }?>
                    <?php if (\Authentication\Model\PermissionManager::userHasPermissionInList("MANAGE.USER.GROUPS,MANAGE.USERS,MANAGE.PATIENT.USERS",$_SESSION['userId'])) {?>
                        <li>
                    ...
                    <?php if (\Authentication\Model\PermissionManager::userHasPermissionInList("MANAGE.COVID19.VACCINES,MANAGE.CHRONIC.DISEASES,MANAGE.ALLERGY.TYPES,MANAGE.QUANTITY.TAKEN.UNITS,MANAGE.MEDICATIONS,MANAGE.PHARMACEUTICALS,MANAGE.FOOD.GROUPS,MANAGE.MEAL.TYPES,MANAGE.LAB.TESTS,MANAGE.VITAL.TESTS,MANAGE.COUNTRIES,MANAGE.PHYSICAL.ACTIVITIES,MANAGE.AGE.RANGES",$_SESSION['userId'])) {?>
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="adminSubmenu">
                                ...
                                <?php }?>
                                <?php if (\Authentication\Model\PermissionManager::userHasPermission("MANAGE.COVID19.VACCINES",$_SESSION['userId'])) {?>
                                    <li>
                                        <a href="/covid19/vaccine/form">Covid-19 Vaccines</a>
                                    </li>
                                <?php }?>
                                ...
                                <?php if (\Authentication\Model\PermissionManager::userHasPermission("MANAGE.QUANTITY.TAKEN.UNITS",$_SESSION['userId'])) {?>
                                    <li>
                                        <a href="/quantity/taken/unit">Quantity Taken (Rx Units)</a>
                                    </li>
                                <?php }?>
                                <?php if (\Authentication\Model\PermissionManager::userHasPermission("MANAGE.RELATIONSHIP.TYPES",$_SESSION['userId'])) {?>
                                    <li>
                                        <a href="/relationship/type">Relationship Types</a>
                                    </li>
                                <?php }?>
                    ...
                    <?php }?>
                    <?php if (\Authentication\Model\PermissionManager::userHasPermissionInList("RPT.PATIENT.DISTRIBUTION.DETAILS,RPT.PATIENT.SMOKING.DRINKING.DETAILS,RPT.PATIENT.PHYSICAL.ACTIVITY.DETAILS",$_SESSION['userId'])) {?>
                        <li>
                            <a href="#reportSubmenu" onclick="toggleLinkState($(this));" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <i class="fas fa-file-signature" style="color:inherit;"></i>&ensp;Reports
                            </a>
                            <ul class="collapse list-unstyled" id="reportSubmenu">
                                <?php if (\Authentication\Model\PermissionManager::userHasPermission("RPT.PATIENT.DISTRIBUTION.DETAILS",$_SESSION['userId'])) {?>
                                    <li>
                                        <a href="/report/patient/distribution/detail/form">Patient Distribution by Age, Sex & Country</a>
                                    </li>
                                <?php }?>
                                <?php if (\Authentication\Model\PermissionManager::userHasPermission("RPT.PATIENT.SMOKING.DRINKING.DETAILS",$_SESSION['userId'])) {?>
                                    <li>
                                        <a href="/report/patient/smoking/drinking/form">Patient Smokers/Drinkers by Age, Sex & Country</a>
                                    </li>
                                <?php }?>
                                <?php if (\Authentication\Model\PermissionManager::userHasPermission("RPT.PATIENT.PHYSICAL.ACTIVITY.DETAILS",$_SESSION['userId'])) {?>
                                    <li>
                                        <a href="/report/patient/physical/activity/form">Patient Physical Activity</a>
                                    </li>
                                <?php }?>
                            </ul>
                        </li>
                    <?php }?>
                    <li>
                        <a href="/about"><i class="fas fa-info-circle" style="color:inherit;"></i>&ensp;About</a>
                    </li>
                    <li>
            ...
            <div id="main-content">
                ...
                <div id="content-bar">
                    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_142696371560784451240ed1_70989959', 'content');
?>
...
>
 ...
 type='text/javascript'>
                ...
                <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_51959453460784451242096_22538476', "auxScripts");
?>
            ...
            $(document).foundation({
                    ...
                    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_114496052960784451242a17_62783270', "foundation");
?>
...
>
 ...
 type='text/javascript'>
            if (!smallScreen.matches) {
                if (sessionStorage.getItem("sidebarSwitch")) {
                    if (sessionStorage.getItem("sidebarSwitch") == "on") {
                        $("#sidebar").addClass("active");
                    } else {
                        $("#sidebar").removeClass("active");
                    }
                } else {
                    var state = $("#sidebar").hasClass("active") ? "on" : "off";//.getItem('sidebarState') === "on";
                    sessionStorage.setItem('sidebarSwitch', state);
                }
            }
        <?php echo '</script'; ?>
>
...
<?php }
/* {block 'styles'} */
class Block_172840432760784451215632_12957714 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'styles' => 
  array (
    0 => 'Block_172840432760784451215632_12957714',
  ),
);
...
/* {/block 'styles'} */
/* {block 'scripts'} */
class Block_45199076760784451216114_61155003 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'scripts' => 
  array (
    0 => 'Block_45199076760784451216114_61155003',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/* {/block 'scripts'} */
/* {block 'dataTable'} */
class Block_3009848736078445121db84_26172907 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'dataTable' => 
  array (
    0 => 'Block_3009848736078445121db84_26172907',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/* {/block 'dataTable'} */
/* {block 'jquery'} */
class Block_4981187316078445121e408_05891196 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'jquery' => 
  array (
    0 => 'Block_4981187316078445121e408_05891196',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/* {/block 'jquery'} */
/* {block 'title'} */
class Block_18400291936078445121ebd7_65316955 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'title' => 
  array (
    0 => 'Block_18400291936078445121ebd7_65316955',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>

        OECS Patient Electronic Health Record - <?php echo $_SESSION['userName'];?>
...
/* {/block 'title'} */
/* {block 'content'} */
class Block_142696371560784451240ed1_70989959 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_142696371560784451240ed1_70989959',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/* {/block 'content'} */
/* {block "auxScripts"} */
class Block_51959453460784451242096_22538476 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'auxScripts' => 
  array (
    0 => 'Block_51959453460784451242096_22538476',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/* {/block "auxScripts"} */
/* {block "foundation"} */
class Block_114496052960784451242a17_62783270 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'foundation' => 
  array (
    0 => 'Block_114496052960784451242a17_62783270',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
