<?php
/* Smarty version 3.1.34-dev-7, created on 2021-04-09 21:17:54
  from '/var/www/oecs/src/smarty/templates/start/login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6070c482b95793_77293227',
...
function content_6070c482b95793_77293227 (Smarty_Internal_Template $_smarty_tpl) {
...
<title>OECS Patient Electronic Health Record</title>
<?php echo '<script'; ?>
...
<style type="text/css">
        ...
        form {
            font-family: 'Poppins', sans-serif !impotant;
        }
...
;
    ...
    var regFormHgt = (smallScreen.matches) ? "730px" : "490px";
...
" required/>
                ...
                <div class="row ">
                    <div class="medium-12 large-12 end columns text-left" style="padding-left:0px;padding-top:8px;">
                        <label style="color:#464646;">
                            <span>
                                Don't have an account yet?&ensp;
                                <a href="#" onclick="return false;" id="regUsr" style="font-family:'Poppins', sans-serif;font-size:1rem;color:#008cba;cursor:pointer;">
                                    Register here
                                </a>
                            </span>
                        </label>
...
"/>
    ...
    <div id="register-modal-content" style='border-radius:10px !important;'>
        <a href="#" onclick="return false;" style="font-family:'Poppins', sans-serif;" class="close simplemodal-close">X</a>
...
<small class="error" id="captchaError">incorrect text</small></span>
            ...
            <div class='row'>
                <div class="medium-6 end columns tos">
                    <label for="termsOfService">
                        <input type="checkbox" id="termsOfService" name="termsOfService" value="1" required style="margin-left:0px !important;"/>
                        <?php echo \Neptune\MessageResources::i18n("user.register.terms.of.service");?>

                    </label> 
                </div>
                <div class="medium-6 end columns text-left">
                    <a href="#" onclick="return false;" style="font-weight:normal;font-size:0.75rem;color:#008cba;font-family:'Poppins', sans-serif;"><i>(click here for terms of use policy)</i></a>
                </div>
            </div>
            <div class="row" >
