...
$usr = (new \Authentication\Model\EduUser())->getObjectById($_SESSION['userId']);
if (!$usr->isSystem() && !(new Authentication\Model\EduPermissionManager())->userHasPermissionAtFacility("ADMIN.OPCACHE.MANAGE", $_SESSION['userId'], $_SESSION['facilityId'])) {
...
<head>
    ...
    <title>OP Cache statistics on <?php echo $opcache->getData('version', 'host'); ?></title>
...
<body style="margin-top:0px !important;padding-top: 0px !important;">
    <div align="left"> <?php echo $_SESSION['menu']; ?> </div>
    <div style="padding-top:10px;" align="right"><a href="/user/home">SM@RT HOME</a>&nbsp;&nbsp;&nbsp;</div>
<header>
    <nav>
        <ul>
...
<footer>
    <a href="www.proteustechnologiesinc.com" target="_blank">www.proteustechnologiesinc.com</a>
</footer>
